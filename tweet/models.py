...
class Tweet(models.Model):
    author = models.ForeignKey(User,verbose_name=_("Author") ,on_delete=models.CASCADE, null=False, related_name="tweets")
    ...
    retweets = models.ManyToManyField(User, through='Retweet')
...
class Comment(models.Model):
    author = models.ForeignKey(User, verbose_name=_("Author"), null=False, related_name="comments", on_delete=models.CASCADE)
    tweet = models.ForeignKey('Tweet', verbose_name=_("Tweet"), on_delete=models.CASCADE, related_name="comments")
    parent_comment = models.ForeignKey('self', verbose_name=_("Parent Comment"), null=True, blank=True, on_delete=models.CASCADE, related_name='replies')
...
class Like(models.Model):
    ...
    author = models.ForeignKey(User, verbose_name=_("Author"), null=False, related_name="likes", on_delete=models.CASCADE)
...
class CommentLike(models.Model):
    comment = models.ForeignKey(Comment, verbose_name=_("comment"), on_delete=models.CASCADE, related_name="comment_likes")
    author = models.ForeignKey(User, verbose_name=_("Author"), null=False, related_name="comment_likes", on_delete=models.CASCADE)
