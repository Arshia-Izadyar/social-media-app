...
from utils.validators.phone_validation import validate_phone_number
...
class User(AbstractUser):
    ...
    phone_number = models.CharField(verbose_name=_("Phone number"), max_length=14, unique=True, validators=[validate_phone_number])
    ...
    uuid = models.UUIDField(verbose_name=_("UUID"), default=uuid.uuid4, unique=True)
